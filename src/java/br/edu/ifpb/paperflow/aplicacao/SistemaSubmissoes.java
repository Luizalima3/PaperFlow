package br.edu.ifpb.paperflow.aplicacao;

import br.edu.ifpb.paperflow.aplicacao.acoes.AcaoAdministrativa;
import br.edu.ifpb.paperflow.dominio.*;
import br.edu.ifpb.paperflow.dominio.categoria.CategoriaEvento;
import br.edu.ifpb.paperflow.infra.notificacao.CanalNotificacoes;
import br.edu.ifpb.paperflow.infra.notificacao.Email;
import br.edu.ifpb.paperflow.infra.notificacao.MensagemNotificacao;
import br.edu.ifpb.paperflow.infra.notificacao.OuvinteEmail;
import br.edu.ifpb.paperflow.infra.notificacao.ServicoEmail;
import br.edu.ifpb.paperflow.infra.notificacao.ServicoEmailMemoria;
import br.edu.ifpb.paperflow.infra.notificacao.TipoNotificacao;
